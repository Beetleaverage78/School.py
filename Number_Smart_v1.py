...
while USER_NAME == 0:
    ...
    easygui.msgbox("Hello {}!" .format(USER_NAME))
...
while user_total != 20:
    if user_total == 10:
        easygui.msgbox("Congrats! You have passed the first level! Level 2 will be harder since the numbers are now between 100-1000. GET READY!")
        user_prog = 2
        print("Total Score: {} points, this means you move on to level 2!" .format(user_total))
        
    while user_total != 20:
        number_A = 0
        number_B = 0
        question = 0
        print("SCORE: " + str(user_total))
        while user_prog == 1 or user_prog == 2:
            if user_prog == 1:
                ...
                number_A = str(randint(100,1000))
                number_B = str(randint(100,1000))
        ...
        if question == 1:
            #If question equals 1, anything under this, will ask the question of which is the bigger number.
            while user_answer != 0:
                user_answer = 0
                ...
                if number_A > number_B:
                    if user_answer == number_A:
                        ...
                        easygui.msgbox("You typed '{}' which is not the number you were suppose to type, try again" .format(user_answer))
                    ...
                    if user_answer == number_B:
                        ...
                        easygui.msgbox("Man you had it so close!, the correct answer was ".format(number_B))
                        break
                    else:
                        easygui.msgbox("You typed '{}' which is not the number you were suppose to type, try again" .format(user_answer))
                else:
                    if user_answer == number_A or user_answer == number_B:
                        easygui.msgbox("They were the same numbers!, So you were right! regardless of which number you chose!")
                    break
                        
        elif question == 2:
            #If question equals 2, anything under this, will ask the question of which is the smallest number.
            while user_answer != 0:
                user_answer = 0
                ...
                if number_A < number_B:
                    if user_answer == number_A:
                        ...
                        easygui.msgbox("So clooooooose!!, the right answer was {}".format(number_A))
                        break
                    else:
                        easygui.msgbox("You typed '{}' which is not the number you were suppose to type, try again" .format(user_answer))
                    ...
                    if user_answer == number_B:
                        ...
                        easygui.msgbox("Oh man! At least you tried, the correct answer was {}".format(number_B))
                        break
                    else:
                        easygui.msgbox("You typed '{}' which is not the number you were suppose to type, try again" .format(user_answer))
                else:
